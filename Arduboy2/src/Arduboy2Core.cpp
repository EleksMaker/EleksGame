...
void Arduboy2Core::paintScreen(uint8_t *image, bool clear){
	...
	{
    LCDCommandMode();
    SPItransfer(0xB0 + i);		// Set row
    SPItransfer(0x02);		// 0x02, Set lower column address (use 0x00 for SD1306 and SSD1309)
    SPItransfer(0x10); // Set higher column address
    LCDDataMode();
...
{ 
    ...
    LCDCommandMode();
    SPItransfer(0xB0 + i);		// Set row
    SPItransfer(0x02);		// 0x02, Set lower column address (use 0x00 for SD1306 and 1309)
    SPItransfer(0x10); // Set higher column address
    LCDDataMode();
